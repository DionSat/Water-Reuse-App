...
@section('body')
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          <div align="center" class="card-header" data-toggle="tooltip" data-placement="bottom"
               title="Users that agreed to be contacted by email"><h3>Contact Opt-In Users</h3></div>
