            ...
            <div class="tab-pane fade" id="nav-addReg" role="tabpanel" aria-labelledby="nav-addReg-tab">
                ...
                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <div class="container" id="adminContainer">
                            <ul>
                                <li>
                                    <a class="text-danger" href="#userManip">User Actions</a>
                                    <ul>
                                        <li>
                                            <a class="text-danger" href="#addAdmin">Add / Remove Administrator Privileges</a>
                                        </li>
                                        <li>
                                            <a class="text-danger" href="#emailUsers">Send Emails to Users</a>
                                        </li>
                                        <li>
                                            <a class="text-danger" href="#emailAdmin">Schedule an Administrative Summary Email</a>
                                        </li>
                                        <li>
                                            <a class="text-danger" href="#banUser">Ban and Unban a User</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="text-danger" href="#regulation">Approve or Deny a New Regulation</a>
                                </li>
                                <li>
                                    <a class="text-danger" href="#deleteReg">Delete / Edit a Regulation</a>
                                </li>
                                <li>
                                    <a class="text-danger" href="#deleteArea">Delete / Edit a State, County or City</a>
                                </li>
                            </ul>
                            <hr id="userManip">
                            <h2>User Actions</h2>
                                <h4 id="addAdmin">Add / Remove Administrator Privileges</h4>
                                    <p>1. Navigate to the <a class="text-danger" href="{{ route('admin') }}" target="_blank">'Administrator Dashboard' </a>page.</p>
                            ...
                            <h2>Approve or Deny a New Regulation</h2>
                                <p>1. Navigate to the <a class="text-danger" href="{{ route('adminUserSubmissionView') }}" target="_blank">'Submissions' </a>page.</p>
